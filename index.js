import{a as f,i as m,S as d}from"./assets/vendor-DU6yh4ar.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(t){if(t.ep)return;t.ep=!0;const r=s(t);fetch(t.href,r)}})();function p(o){return f.get("https://pixabay.com/api/?",o).then(e=>{var s,i;if(!((i=(s=e.data)==null?void 0:s.hits)!=null&&i.length))throw new Error("Sorry, there are no images matching your search query. Please try again!");return e.data.hits}).catch(e=>(m.show({message:`${e.message}`,messageColor:"white",iconUrl:"../img/blocked.svg",position:"topRight",color:"#ef4040"}),[]))}function g(o){return o.map(e=>`<li class="gallery-item">
